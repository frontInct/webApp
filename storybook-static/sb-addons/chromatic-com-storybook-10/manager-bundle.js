try {
  ;(() => {
    ...
    var Se,
      ae = Gr(() => {
        Se = {
          NODE_ENV: 'production',
          NODE_PATH: [
            '/Users/user/Documents/1. intership/1. mine/webApp/node_modules/.pnpm/storybook@8.6.14_prettier@3.5.3/node_modules/storybook/bin/node_modules',
            '/Users/user/Documents/1. intership/1. mine/webApp/node_modules/.pnpm/storybook@8.6.14_prettier@3.5.3/node_modules/storybook/node_modules',
            '/Users/user/Documents/1. intership/1. mine/webApp/node_modules/.pnpm/storybook@8.6.14_prettier@3.5.3/node_modules',
            '/Users/user/Documents/1. intership/1. mine/webApp/node_modules/.pnpm/node_modules',
          ],
          STORYBOOK: 'true',
          PUBLIC_URL: '.',
        }
    ...
    uc(Yr, {
      ...
      FILE_COMPONENT_SEARCH_RESPONSE: () => _c,
      FORCE_REMOUNT: () => Mc,
      FORCE_RE_RENDER: () => Ac,
      GLOBALS_UPDATED: () => Tc,
      NAVIGATE_URL: () => Fc,
    ...
    function ti(
      ...
      let O = r === 10 ? 1e3 : 1024,
        ...
        U = h < 0,
        G = Math[y]
      if (typeof e != 'bigint' && isNaN(e)) throw new TypeError(Ad)
      if (typeof G !== Md) throw new TypeError(Td)
      if (
        (U && (h = -h),
    ...
    var qd = Object.create,
      ...
      }),
      {
        ...
        CHROMATIC_BASE_URL: _r = o5 || 'https://www.chromatic.com',
        CHROMATIC_API_URL: s5 = `${_r}/api`,
      } = Se,
      ...
      _5 = w(Qr)(({ theme: e }) => ({ padding: '4px 8px', fontSize: e.typography.size.s1 })),
      M5 = w(Je)(
        ({ theme: e }) => ({
      ...
      ko = ({ active: e, count: t, label: n, status: r, ...i }) =>
        a.createElement(
          M5,
          { active: e, ...i },
          a.createElement(_5, { status: r, 'data-badge': e, 'data-status': r }, t),
          a.createElement(A5, null, (0, x5.default)(n, t))
        ),
      T5 = () => !0,
    ...
    var Ye = e => !(!e || !e.length),
      Me = {
        OperationDefinition(e) {
          ...
          return (
            ...
            Ye(e.variableDefinitions) &&
              (e.name || (t += ' '),
              (t += '(' + e.variableDefinitions.map(Me.VariableDefinition).join(', ') + ')')),
            Ye(e.directives) && (t += ' ' + e.directives.map(Me.Directive).join(' ')),
            t + ' ' + Me.SelectionSet(e.selectionSet)
          )
        },
        VariableDefinition(e) {
          var t = Me.Variable(e.variable) + ': ' + Qe(e.type)
          return (
        ...
        Field(e) {
          ...
          if (Ye(e.arguments)) {
            var n = e.arguments.map(Me.Argument),
              r = t + '(' + n.join(', ') + ')'
            t =
              r.length > 80
                ? t +
...
`
  ...
  `
          ...
          return (
            Ye(e.directives) && (t += ' ' + e.directives.map(Me.Directive).join(' ')),
            e.selectionSet ? t + ' ' + Me.SelectionSet(e.selectionSet) : t
          )
        },
        StringValue: e => (e.block ? Tu(e.value) : Au(e.value)),
...
`
  ...
  `
        ...
        FragmentSpread(e) {
          var t = '...' + e.name.value
          return Ye(e.directives) && (t += ' ' + e.directives.map(Me.Directive).join(' ')), t
        },
        InlineFragment(e) {
          var t = '...'
          return (
        ...
        Directive(e) {
          var t = '@' + e.name.value
          return Ye(e.arguments) && (t += '(' + e.arguments.map(Me.Argument).join(', ') + ')'), t
        },
...
`
          ...
          : e,
      _o = e => e.split(Ou).map(Ru).join('').trim(),
      Mo = new Map(),
      Ga = new Map(),
      bl = e => {
        var t
...
# ${n}`,
      ...
      Iu = e => {
        ...
        return (
          typeof e == 'string'
            ? ((t = Ao(e)), (n = Ga.get(t) || Mu(e)))
            : ((t = e.__key || Ao(e)), (n = Ga.get(t) || e)),
          n.loc || bl(n),
          (n.__key = t),
          Ga.set(t, n),
          n
...
`
    ...
    function Ro(e) {
      var t = n => e(n)
      return (
        (t.toPromise = () => yl(Ar(1)(Ve(n => !n.stale && !n.hasNext)(t)))),
              ...
              h.kind !== 'query'
                ...
                : (v = So(b => {
                    ...
                    return b.stale || b.hasNext
                      ...
                      : ta([
                          C,
                          Ri(() => ((b.stale = !0), b))(Ar(1)(Ve(O => O.key === h.key)(c.source))),
                        ])
                  })(v)),
              h.kind !== 'mutation'
                ? (v = vl(() => {
    ...
    var j = w.div(
      ...
      _l = ({ localBuildProgress: e, withEmoji: t = !1, ...n }) => {
    ...
    function Ms(e) {
      ...
      var p = M2.exec(t.substring(0, 50))
      if (p) {
    ...
    var j2 = ue({
      ...
      Ae = w(ro)(({ theme: e }) => ({ marginBottom: '-4px', marginTop: '-4px', left: -8 })),
      tm = w.div(({ theme: e }) => ({
        width: 220,
        padding: 3,
        color: e.base === 'light' ? e.color.defaultText : e.color.light,
            ...
            we,
            {
              ...
              tooltip: a.createElement(
                ...
                a.createElement(
                  'div',
                  null,
                  a.createElement(_l, { localBuildProgress: i, small: !0, withEmoji: !0 })
                ),
                a.createElement(
                  Al,
                  null,
    ...
    var vm = w.label(e => ({
      ...
      js = W(
        (
          ...
          let [h, v] = _e(Po({ error: r, value: y, lastErrorValue: c })),
            b = `${e}-error`
          X(() => {
      ...
      tt = ({
        ...
        let d = Ut().color[e],
          m = a.createElement(
            ...
            t && a.createElement(Mm, { className: 'sbds-list-item-left' }, t),
    ...
    var p4 = w.div(
      ...
      v4 = ({ hidden: e, ignoreConfig: t, ignoreSuggestions: n, onOpen: r }) => {
        let [i] = Ee(Mr),
          ...
          [s, c] = _e(() => !!localStorage.getItem(bo)),
          d = H(() => {
    ...
    var _ = le.arrayToEnum([
      ...
      M4 = e => JSON.stringify(e, null, 2).replace(/"([^"]+)":/g, '$1:'),
    ...
    var pt = class extends Q {
      _parse(e) {
        if ((this._def.coerce && (e.data = String(e.data)), this._getType(e) !== _.string)) {
          ...
          return T(r, { code: x.invalid_type, expected: _.string, received: r.parsedType }), z
        }
        let t = new Ze(),
          n
    ...
    var Jt = class extends Q {
      ...
      _parse(e) {
        if ((this._def.coerce && (e.data = Number(e.data)), this._getType(e) !== _.number)) {
          let r = this._getOrReturnCtx(e)
          return T(r, { code: x.invalid_type, expected: _.number, received: r.parsedType }), z
        }
        let t,
          n = new Ze()
        for (let r of this._def.checks)
    ...
    var Xt = class extends Q {
      ...
      _parse(e) {
        if ((this._def.coerce && (e.data = BigInt(e.data)), this._getType(e) !== _.bigint)) {
          let r = this._getOrReturnCtx(e)
          return T(r, { code: x.invalid_type, expected: _.bigint, received: r.parsedType }), z
        }
        let t,
          n = new Ze()
        for (let r of this._def.checks)
    ...
    var sa = class extends Q {
      _parse(e) {
        if ((this._def.coerce && (e.data = !!e.data), this._getType(e) !== _.boolean)) {
          ...
          return T(t, { code: x.invalid_type, expected: _.boolean, received: t.parsedType }), z
        }
        return Be(e.data)
      }
    }
    ...
    var wn = class extends Q {
      _parse(e) {
        if ((this._def.coerce && (e.data = new Date(e.data)), this._getType(e) !== _.date)) {
          let r = this._getOrReturnCtx(e)
          return T(r, { code: x.invalid_type, expected: _.date, received: r.parsedType }), z
        }
    ...
    var pr = class extends Q {
      _parse(e) {
        if (this._getType(e) !== _.symbol) {
          let t = this._getOrReturnCtx(e)
          return T(t, { code: x.invalid_type, expected: _.symbol, received: t.parsedType }), z
        }
        return Be(e.data)
      }
    }
    ...
    var ca = class extends Q {
      _parse(e) {
        if (this._getType(e) !== _.undefined) {
          let t = this._getOrReturnCtx(e)
          return T(t, { code: x.invalid_type, expected: _.undefined, received: t.parsedType }), z
        }
        return Be(e.data)
      }
    }
    ...
    var da = class extends Q {
      _parse(e) {
        if (this._getType(e) !== _.null) {
          let t = this._getOrReturnCtx(e)
          return T(t, { code: x.invalid_type, expected: _.null, received: t.parsedType }), z
        }
        return Be(e.data)
      }
    }
    ...
    var _t = class extends Q {
      _parse(e) {
        let t = this._getOrReturnCtx(e)
        return T(t, { code: x.invalid_type, expected: _.never, received: t.parsedType }), z
      }
    }
    _t.create = e => new _t({ typeName: D.ZodNever, ...$(e) })
    var hr = class extends Q {
      _parse(e) {
        if (this._getType(e) !== _.undefined) {
          let t = this._getOrReturnCtx(e)
          return T(t, { code: x.invalid_type, expected: _.void, received: t.parsedType }), z
        }
        return Be(e.data)
      }
    }
    ...
    var gt = class extends Q {
      _parse(e) {
        ...
        if (t.parsedType !== _.array)
          return T(t, { code: x.invalid_type, expected: _.array, received: t.parsedType }), z
    ...
    var be = class extends Q {
      ...
      _parse(e) {
        if (this._getType(e) !== _.object) {
          ...
          return T(s, { code: x.invalid_type, expected: _.object, received: s.parsedType }), z
        }
      ...
      Zl = class extends Q {
        _parse(e) {
          ...
          if (t.parsedType !== _.object)
            return T(t, { code: x.invalid_type, expected: _.object, received: t.parsedType }), z
    ...
    var Mt = class extends Q {
      _parse(e) {
        ...
        if (n.parsedType !== _.array)
          return T(n, { code: x.invalid_type, expected: _.array, received: n.parsedType }), z
    ...
    var fr = class extends Q {
        ...
        _parse(e) {
          ...
          if (n.parsedType !== _.object)
            return T(n, { code: x.invalid_type, expected: _.object, received: n.parsedType }), z
          let r = [],
            i = this._def.keyType,
      ...
      gr = class extends Q {
        ...
        _parse(e) {
          ...
          if (n.parsedType !== _.map)
            return T(n, { code: x.invalid_type, expected: _.map, received: n.parsedType }), z
    ...
    var Sn = class extends Q {
      _parse(e) {
        ...
        if (n.parsedType !== _.set)
          return T(n, { code: x.invalid_type, expected: _.set, received: n.parsedType }), z
        let r = this._def
        r.minSize !== null &&
    ...
    var ea = class extends Q {
        ...
        _parse(e) {
          ...
          if (t.parsedType !== _.function)
            return T(t, { code: x.invalid_type, expected: _.function, received: t.parsedType }), z
          function n(o, s) {
            return ur({
              data: o,
              path: t.path,
        ...
        args(...e) {
          return new ea({ ...this._def, args: Mt.create(e).rest(Kt.create()) })
        }
        returns(e) {
        ...
        static create(e, t, n) {
          return new ea({
            args: e || Mt.create([]).rest(Kt.create()),
            returns: t || Kt.create(),
    ...
    var xn = class extends Q {
      ...
      _parse(e) {
        ...
        if (t.parsedType !== _.promise && t.common.async === !1)
          return T(t, { code: x.invalid_type, expected: _.promise, received: t.parsedType }), z
    ...
    var Nt = class extends Q {
      _parse(e) {
        return this._getType(e) === _.undefined ? Be(void 0) : this._def.innerType._parse(e)
      }
      unwrap() {
    ...
    var tn = class extends Q {
      _parse(e) {
        return this._getType(e) === _.null ? Be(null) : this._def.innerType._parse(e)
      }
      unwrap() {
        return this._def.innerType
      }
    ...
    var yr = class extends Q {
      _parse(e) {
        if (this._getType(e) !== _.nan) {
          let t = this._getOrReturnCtx(e)
          return T(t, { code: x.invalid_type, expected: _.nan, received: t.parsedType }), z
        }
        return { status: 'valid', value: e.data }
      }
    }
            ...
            async y => {
              if ((y.message === 'login' && m.current?.(c), y.message === 'grant'))
                try {
                  ...
                  d.current = k
                  let E = Ss(k),
                    { data: h } = await l.query(Mp, {}, { fetchOptions: E })
...
`),
    ...
    function M(e) {
      ...
      return M.array(e) ? 'Array' : M.plainFunction(e) ? 'Function' : Pr(e) || 'Object'
    }
    M.array = Array.isArray
    M.arrayOf = (e, t) => (!M.array(e) && !M.function(t) ? !1 : e.every(n => t(n)))
    M.asyncGeneratorFunction = e => Pr(e) === 'AsyncGeneratorFunction'
    ...
    M.primitive = e => M.null(e) || u3(typeof e)
    ...
    function M0(e, t, n, r) {
      ...
      l.addEventListener(t, n, { passive: !0 }), i || M0(Ca(l.parentNode), t, n, r), r.push(l)
    }
    function L3(e, t, n, r) {
      ...
      g7 = class extends jt {
        ...
        componentDidUpdate(e) {
          ...
          g('lifecycle', q.INIT, q.READY) &&
            p.update({ lifecycle: M1(u) || k ? q.TOOLTIP : q.BEACON }),
            f('index') &&
...
`),
    ...
    function zr({ localBuildProgress: e }) {
      return a.createElement(
        ...
        a.createElement(_l, { center: !0, muted: !0, small: !0, localBuildProgress: e })
      )
    }
    var $7 =
          ...
          return a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(
                za,
                null,
                a.createElement(_l, { localBuildProgress: n, withEmoji: !0 })
              ),
              m
                ? a.createElement(
                    Je,
      ...
      _6 = ({ isAccepted: e, selectedBrowser: t, browserResults: n, onSelectBrowser: r }) => {
        Ut()
      ...
      T6 = ({ isAccepted: e, modeOrder: t, modeResults: n, onSelectMode: r, selectedMode: i }) => {
        ...
        return a.createElement(
          ...
          s
            ...
            : a.createElement(M6, null, o, a.createElement(z1, null, i.name))
        )
      },
      U1 = () => {
        let e = on(),
      ...
      I6 = ({ isOutdated: e }) => {
        let { baselineImageVisible: t, diffVisible: n, focusVisible: r } = Lr(),
          { toggleBaselineImage: i, toggleDiff: l, toggleFocus: o } = An(),
    ...
    var U6 = {
      ...
      G6 = {
        date: _i({ formats: U6, defaultWidth: 'full' }),
        time: _i({ formats: $6, defaultWidth: 'full' }),
        dateTime: _i({ formats: W6, defaultWidth: 'full' }),
      },
      q6 = G6,
      Y6 = {
    ...
    function Mf(e, t, n) {
      ...
      var d = tc(_f(n), { addSuffix: !!n?.addSuffix, comparison: c }),
        m,
        u
    ...
    function Af(e, t) {
      return Ur(1, arguments), Mf(e, Date.now(), t)
    }
    var Tf = {
    ...
    var Of = e => Af(e, { addSuffix: !0, locale: { ...ec, formatDistance: Ff } }),
      qn = w.div(({ theme: e }) => ({
        gridArea: 'info',
        display: 'flex',
        justifySelf: 'start',
  ...
  `,
      ...
      Pf = ({
        ...
        let { baselineImageVisible: s, diffVisible: c, focusVisible: d } = Lr(),
          { toggleBaselineImage: m, toggleSettings: u, toggleWarnings: p } = An(),
          f = Y0(),
      ...
      Qf = ({ active: e, api: t }) => {
        ...
        X(() => {
          ...
          return (
            ...
            window.addEventListener('offline', Aa),
            () => {
              window.removeEventListener('online', He), window.removeEventListener('offline', Aa)
            }
          )
        }, [])
        let [c] = Ee(u5),
