try {
  ;(() => {
                  ...
                  return function (u) {
                    var d = function () {
                      ...
                      for (_ = 0; _ < S; _++) {
                        ...
                        ;(T = !1), (y = new p(!1)), h.set(arguments[_], y), (h = y)
                      }
                      return (
    ...
    var $ = Se(se()),
      ...
      Ge = Q(function () {
        let [e, t] = G(),
          { viewports: l = de, defaultOrientation: c, defaultViewport: a, disable: w } = F(R, {}),
          p = Pe(l),
          o = oe(),
          [i, m] = z(!1)
        a &&
          ...
          w || Object.entries(l).length === 0
            ...
            : s.createElement(
                ...
                s.createElement(
                  ...
                  {
                    placement: 'top',
                    tooltip: ({ onHide: u }) => s.createElement(q, { links: Me(p, n, t, u) }),
                    closeOnOutsideClick: !0,
                    onVisibleChange: m,
                  },
                  s.createElement(
