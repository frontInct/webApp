try {
  ;(() => {
        ...
        ;(e.innerHTML = ''),
          ...
          (f = (function (m, g = [], w) {
            ...
            for (let { color: _ } of g) {
              let V = Mt('div')
              ;(V.className = `${On} ${w}`), V.style.setProperty('--bgc', _)
              let H = Mt('div')
    ...
    function Ot(e, t) {
      ...
      var s = Ut(e)
      return s.host ? Ot(s.host, t) : Ot(e, Ut(t).host)
    }
    function ze(e) {
    ...
    function Va(e) {
      let {
        ...
        { back: g, close: w, last: B, next: _, skip: V } = b,
        H = { primary: w }
      return (
        r &&
          ((H.primary = i ? B : _),
            ...
            '../../node_modules/deepmerge/dist/cjs.js'(e, t) {
              ...
              function v(m, g, w) {
                ...
                var B = Array.isArray(g),
                  _ = Array.isArray(m),
                  V = B === _
                return V ? (B ? w.arrayMerge(m, g, w) : N(m, g, w)) : l(g, w)
              }
              v.all = function (m, g) {
                if (!Array.isArray(m)) throw new Error('first argument should be an array')
                return m.reduce(function (w, B) {
                  return v(w, B, g)
                }, {})
              }
              var T = v
              ...
              t.exports = function (l, p) {
                ...
                function H(E) {
                  ...
                  function x(W, j, L, z, M) {
                    ...
                    var K = JSON.stringify(E, function (Y, O) {
                      var ne = Re(O)
                ...
                function Ke(E) {
                  function x(W, j, L, z, M) {
                    ...
                    for (var Y in K) {
                      var O = E[Y]
                      if (i(E, Y) && typeof O != 'function') return ke(L, z, M, Y, Re(O))
                      if (!O)
                        return new v(
                          'Invalid ' +
                            z +
...
Valid keys: ` +
          ...
          (Oo = le({
            '../../node_modules/prop-types/index.js'(e, t) {
              ;(n = vr()), (r = !0), (t.exports = wo()(n.isElement, r))
              var n, r
            },
          })),
          (To = le({
        ...
        ;(Li = {
          ...
          arrow: { order: 500, enabled: !0, fn: Oi, element: '[x-arrow]' },
          flip: {
            order: 600,
            enabled: !0,
            fn: Ii,
          ...
          (tn = (function (e) {
            ...
            function n(r) {
              ...
              return (
                lt(this, n),
                (o = t.call(this, r)),
                re(Oe(o), 'setArrowRef', function (i) {
                  o.arrowRef = i
                }),
                re(Oe(o), 'setChildRef', function (i) {
                  o.childRef = i
                }),
                re(Oe(o), 'setFloaterRef', function (i) {
                  o.floaterRef = i
                }),
                re(Oe(o), 'setWrapperRef', function (i) {
                  o.wrapperRef = i
                }),
                re(Oe(o), 'handleTransitionEnd', function () {
                ...
                re(Oe(o), 'handleMouseEnter', function () {
                  var i = o.props,
                    a = i.event,
                    s = i.open
                  if (!(A.boolean(s) || Wt())) {
                ...
                re(Oe(o), 'handleMouseLeave', function () {
                  var i = o.props,
                    a = i.event,
                    s = i.eventDelay,
                    c = i.open
                ...
                },
                {
                  ...
                  value: function () {
                    var r = this.state,
                      ...
                      w = {}
                    return (
                      i ? (w.wrapperInPortal = g) : (w.wrapperAsChildren = g),
                      y.createElement(
                        'span',
                        null,
                        y.createElement(
          ...
          (Xa = class extends Le {
            ...
            componentDidUpdate(e) {
              ...
              let {
                ...
                { changed: f, changedFrom: h } = wt(e, this.props),
                b = s.info(),
          ...
          (ro = class extends Le {
            ...
            componentDidUpdate(e, t) {
              ...
              let { action: n, controlled: r, index: o, lifecycle: i, status: a } = this.state,
                ...
                { changed: T } = wt(e, this.props),
                { changed: m, changedFrom: g } = wt(t, this.state),
                w = Ue(this.props, p[o]),
                B = !oe(d, p),
              ...
              !r &&
                ...
                this.callback({ ...this.state, type: pe.TARGET_NOT_FOUND, step: w }))
              let H = { ...this.state, index: o, step: w }
