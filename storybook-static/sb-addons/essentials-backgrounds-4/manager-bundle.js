    ...
    var X = le((Q, V) => {
      ...
      ;(function (e) {
        ...
        return (function r(i, I, s) {
          ...
          for (var n = typeof w == 'function' && w, u = 0; u < s.length; u++) t(s[u])
          return t
        })(
          {
            1: [
              ...
              function (r, i, I) {
                ...
                i.exports = function (a) {
                  ...
                  return function (_) {
                    var p = function () {
                      ...
                      return (
                        O && (b.has(arguments[A]) ? (R = b.get(arguments[A])) : (O = !1)),
                        O || ((R = _.apply(null, arguments)), b.set(arguments[A], R)),
                        a > 0 &&
                    ...
                    return (p.limit = a), (p.wasMemoized = !1), (p.cache = d), (p.lru = l), p
                  }
                }
                function t(a, d) {
                  var l = a.length,
                ...
                function n(a) {
                  ...
                  for (
                    ...
                    p >= 0 && ((l = a[p]), (_ = l.cacheItem.get(l.arg)), !_ || !_.size);
                    p--
                  )
        ...
        return u
          ? t.concat(
              u.map(function (a) {
                var d, l
                return (l =
                  (d = a.match(/[\t ]/g)) === null || d === void 0 ? void 0 : d.length) !== null &&
                  l !== void 0
                  ? l
                  : 0
              })
